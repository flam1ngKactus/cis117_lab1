...
if __name__ == "__main__":
    ...
    while True:
        user_input = input("Which game would you like to play? Number Guessing (1) | Rock Paper Scissors (2) | NOTHING! I'M TIRED OF YOUR GAMES (0): ")
        ...
        if user_input == 0:
            ...
            rps() # place holder for guessing game
        elif user_input == 2:
            rps()
        else:
